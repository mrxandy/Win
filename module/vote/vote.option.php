...
?>
	...
	//有无修改票数权限
	$permit = System :: check_func( 'vote-data-mod');
	...
	?>
        ...
        <table cellpadding="0" cellspacing="0" class="form">
        	...
        	<tr>
                ...
                <td>
                <?php
				echo $_G['module']['vote']["group"][$_CACHE[$appid]['group'][$gid]["type"]];
				?>
                </td>
            </tr>
			...
			if( $_G['licence']['type'] != 'free' && $permit ){
				...
				$stat = $_CACHE[$appid]['form']["stat"] <= 10000 ? Vote :: stat( $fid, $gid, $row['id'] ) : '-';
