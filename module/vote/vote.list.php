...
<?php
	...
	if ($action){
		...
		switch($action){
			...
			case "delete":
				...
				//检查权限
				System :: check_func( 'vote-list-del', false );
    ...
    <form name="form1" method="get" action="?">
        <span class="action">
            <button type="button" class="cancel" onclick="location.href='?s=account&q=<?php echo urlencode($_G['manager']['account']);?>';">我的投票</button>
            <button type="button" class="button" onclick="location.href='<?php echo $appid;?>.edit.php';">新增投票</button>
    ...
    <script type="text/javascript">
        ...
        Mo.reader(function(){
            ...
            if($_GET['mark']){
            ?>
			Mo.Tips( Mo.$("mark-<?php echo $_GET['mark'];?>"), event,'','点这里开始管理投票的选项组和子选项，只需几分钟即可完成你的工作','click',70,-8,{'unique':'bubble'});
            <?php
            }
            ?>
	...
	//如果没有权限，则限制为本人
	if( System :: check_func( 'vote-other') == false ) $sql.=" and aid = ".$_G['manager']['id'];
